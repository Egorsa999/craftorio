...
public class WinScreen implements Screen {
    ...
    public WinScreen(final MainGame game) {
        ...
        paramTitle.size = 72;
        paramTitle.color = new Color(0.2f, 1.0f, 0.2f, 1f);
        ...
        btnUpTex = createRectTexture(300, 80, new Color(0.1f, 0.5f, 0.1f, 1f), new Color(0.2f, 0.8f, 0.2f, 1f));
        btnDownTex = createRectTexture(300, 80, new Color(0.0f, 0.3f, 0.0f, 1f), new Color(0.1f, 0.6f, 0.1f, 1f));
