...
public class Furnace extends DamageableBuilding implements ThroughItem, ReceiveItem, PowerConsumer, PowerConnectable, Craftable {
    ...
    private final float maxPowerPerTick = BalanceConfig.FURNACE_POWER_CONSUMPTION * GameConfig.TICK_TIME;
    ...
    public Furnace(BuildingRegistry registry, Point anchor, Direction direction) {
        ...
        this.craftModule = new CraftModule(50, 0.0f, List.of(Recipe.IRON_INGOT, Recipe.COPPER_INGOT, Recipe.STEEL, Recipe.GLASS), true, maxPowerPerTick);
